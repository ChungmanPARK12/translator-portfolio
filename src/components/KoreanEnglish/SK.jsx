import './CSS1.css';
import aiEssayImage from '../../assets/Sk/1.png';
import aiEssayImage2 from '../../assets/Sk/2.png';
      ...
      <div className="translation-table-KE">
        ...
        <div className="translation-row-KE">
          <div className="translation-col-K">
            ...
            <div className="image-text-wrapper">
              <img src={aiEssayImage} alt="AI Essay A" className="translation-image-sk" />
            </div>
          </div>
          ...
          <div className="translation-col-E">
            ...
            <p>
              <h4>Sk group accelerate to expand the area of business.</h4> 
            </p>
            <p>
              It has been confirmed that the group recently instructed several affiliates in charge of semiconductor 
              materials to secure core technologies or acquire capabilities that can generate synergy with their existing businesses.
            </p>
            <p>
              On the 11th, industry sources said SK Group's semiconductor affiliates are actively reviewing M&A and 
              partnerships to expand into new business.
            </p>        
          </div>
        </div>
        ...
        <div className="translation-row-KE">
          <div className="translation-col-K">
            <h4>Korean</h4>
            <div className="image-text-wrapper">
              <img src={aiEssayImage2} alt="AI Essay B" className="translation-image-sk" />
            </div>
          </div>
